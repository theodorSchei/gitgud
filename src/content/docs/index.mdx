...
Bli med på denne reisen gjennom Git-verdenen og ta kontroll over din kodehistorikk. Det er en ferdighet du vil ha stor nytte av i din karriere, så la oss komme i gang!

<SelectCorrect
  question="Det kommer noen spørsmål fremover, dette er kun så du kan teste deg selv. Er du klar?"
  correct="Jeg er klar!"
  wrong1="Ikke ennå.."
  wrong2="Nei." 
/>
